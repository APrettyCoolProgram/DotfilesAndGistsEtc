...
## CODE ORGANIZATION
`/` - root is where solution files, root MD documentation, SD replication artifacts go.<br>
`/bin` – not checked in is where binaries will be generated by the MSBuild system<br>
`/dep` – dependencies that aren’t a part of the SDK<br>
