<h2 align="center">
  <img src="repodata/img/dotnet-core-csharp-class-library-template-logo.png" alt="C# .NET Core Class Library project template logo" width="200">
  <br>
  A C# .NET Core Class Library project template for Visual Studio 2019
  <br>
</h2>
...
1. Download the [dotnet-core-csharp-class-library-template](export/dotnet-core-csharp-class-library-template.zip)
