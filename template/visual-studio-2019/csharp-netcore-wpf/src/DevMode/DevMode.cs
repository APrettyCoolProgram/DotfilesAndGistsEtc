...
/* Application Development Mode logic. Please see documentation at the end of this file for more information.
 */
using System;
...
Development Mode allows you to do a few special things when an application starts, such as:

    * Execute code that you want to quickly test
    * Create data at runtime
    # Etc.
